...
export const translations = {
  fr: {
    ...
    'contactForm.tabContact': 'Envoyer un message',
    'contactForm.tabPrivacy': 'Confidentialité garantie',
    'contactForm.privacyTitle': 'Vos données sont protégées',
    'contactForm.privacyContent': 'Toutes les informations transmises via ce formulaire sont traitées avec la plus stricte confidentialité. Nous nous engageons à protéger vos données personnelles conformément à la réglementation applicable.',
